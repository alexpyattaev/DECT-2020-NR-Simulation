classdef dect_rx < handle
    ...
    methods
        ...
        function [PCC_user_bits, PDC_user_bits] = demod_decode_packet(obj, samples_antenna_rx)
            ...
            [antenna_streams_mapped_rev, ~]= lib_6_generic_procedures.ofdm_signal_generation_Cyclic_prefix_insertion_rev( ...
            ...
            if active_equalization_detection == true
                ...
                if N_eff_TX == 1 && N_RX ==1
                    ...
                    x_PCC_rev = lib_rx.equalization_SISO_zf(antenna_streams_mapped_rev, ...
                        ch_estim, physical_resource_mapping_PCC_cell);
                    x_PDC_rev = lib_rx.equalization_SISO_zf(antenna_streams_mapped_rev, ...
                        ch_estim, physical_resource_mapping_PDC_cell);

                % SIMO (Maximum Ratio Combining (MRC))
                elseif N_eff_TX == 1 && N_RX > 1

                    x_PCC_rev = lib_rx.equalization_SIMO_mrc(antenna_streams_mapped_rev, ...
                        ch_estim, physical_resource_mapping_PCC_cell, N_RX);
            ...
            % no equalization, a great debugging tool when using awgn channel
                ...
                x_PCC_rev = lib_7_Transmission_modes.subcarrier_unmapping_PCC( ...
                    antenna_streams_mapped_rev, physical_resource_mapping_PCC_cell);
                x_PDC_rev = lib_7_Transmission_modes.subcarrier_unmapping_PDC( ...
                    antenna_streams_mapped_rev, physical_resource_mapping_PDC_cell);                
            end
            ...
            % decode PDC
            [PDC_user_bits, PDC_harq_buf_report, pdc_dec_dbg] = lib_7_Transmission_modes.PDC_decoding( ...
                x_PDC_rev,...
                N_TB_bits,...
                Z,...
                network_id,...
